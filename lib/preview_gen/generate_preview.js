...
export { getOrGeneratePreview };

const getOrGeneratePreview = async (absolutePath) => {
  ...
  await generatePreview(absolutePath, previewPath);
...
const generatePreview = async (inputPath, outputPath) => {
  ...
  filterGraph += 'scale=-2:128,thumbnail=4096';
